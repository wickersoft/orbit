...
Func _OrbitRenderer_RenderLightCurve(ByRef $orbit, ByRef $observations, $startDay, $endDay, $brightestMag, $darkestMag)
	...
	For $i = 0 to $_ORBITRENDERER_IWIDTH - 1 step 2
        ...
        $polarC = _Orbit_CalcPolarCoordsAtDate($orbit, $d)
		$cartesianC = _Orbit_CalcCartesianCoordsAtDate($orbit, $d)
		...
		$mag_new = _Orbit_CalcApparentMagnitude($orbit, $polarC[0], $earthDist)
